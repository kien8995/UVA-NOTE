...
function executeLine(line, doneFn) 
{
    ...
    case 'view':
        ...
        console.log('\n' + "---------------------Problem Detail---------------------".rainbow + '\n');
        console.log("Problem ID: ".yellow + ar[2].underline + '\n');
        console.log("Problem Number: ".yellow + ar[4].underline + '\n');
        console.log("Title: ".yellow + ar[6].underline + '\n');
        console.log("Run-Time Limit : ".yellow + ar[40].underline + " ms".yellow + '\n');
        console.log("Accepted User: ".green + ar[8].underline + '\n');
        console.log("Accepted : ".green + ar[38].underline + '\n');
        console.log("Best Runtime: ".magenta + ar[10].underline + " s".magenta +'\n');
        console.log("Best Memory: ".magenta + ar[12].underline + " byte".magenta +'\n');
        console.log("Can't be Judged : ".yellow + ar[18].underline + '\n');
        console.log("Restricted Function : ".yellow + ar[24].underline + '\n');
        console.log("In Queue : ".cyan + ar[20].underline + '\n');
        console.log("Submission Error : ".red + ar[16].underline + '\n');
        console.log("Compilation Error : ".red + ar[22].underline + '\n');
        console.log("Runtime Error : ".red + ar[26].underline + '\n');
        console.log("Output Limit Exceeded : ".red + ar[28].underline + '\n');
        console.log("Time Limit Exceeded : ".red + ar[30].underline + '\n');
        console.log("Memory Limit Exceeded : ".red + ar[32].underline + '\n');
        console.log("Wrong Answer : ".red + ar[34].underline + '\n');
        console.log("Presentation Error : ".red + ar[36].underline + '\n');
        var str = "";
        if(ar[42]==0)
        {
            str = "unavailable".red;
        ...
        console.log("Problem Status: " + str + '\n');
        doneFn();
        ...
        //       __dirname
        httpreq.download('http://uva.onlinejudge.org/external/'+ vol + '/' + theProb + '.pdf',
