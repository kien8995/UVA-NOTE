...
////////////////////////////// -------------------------------------------------
        this.getProblemURL = function(probNum, callback){
            fetchProbs(function(e, probs){
                var theProb = parseInt(probNum);
                var vol = Math.floor(theProb/100);
                if (theProb)
                {
                    callback(null, 'http://uva.onlinejudge.org/external/'+ vol + '/' + theProb + '.html');
                    return;
                }
        ...
        this.getProblemPdfURL = function(probNum, callback){
            fetchProbs(function(e, probs){
                var theProb = parseInt(probNum);
                var vol = Math.floor(theProb/100);
                if (theProb)
                {
                    callback(null, 'http://uva.onlinejudge.org/external/'+ vol + '/' + theProb + '.pdf');
                    return;
                }
        ...
        this.getProblemPDF = function(probNum, callback){
            fetchProbs(function(e, probs){
                var theProb = parseInt(probNum);
                var vol = Math.floor(theProb/100);
                if (theProb)
                {
                    callback(null, 'http://FreeHTMLtoPDF.com/?convert=http%3A%2F%2Fuva.onlinejudge.org/external/'+ vol + '/' + theProb + '.html');
                    return;
                }
        ...
        /*this.getProblemFILE = function(probNum, callback){
            fetchProbs(function(e, probs){
                var theProb = parseInt(probNum);
                var vol = Math.floor(theProb/100);
                if (theProb)
                {
                    //callback(null, 'view-source:http://uva.onlinejudge.org/external/'+ vol + '/' + theProb + '.html');
                    var httpreq = require('httpreq');

					httpreq.download(
    					'http://uva.onlinejudge.org/external/'+ vol + '/' + theProb + '.pdf',
    					__dirname + '/test.pdf'
        ...
        this.getSourceProblemURL = function(probNum, callback){
            fetchProbs(function(e, probs){
                var theProb = parseInt(probNum);
                var vol = Math.floor(theProb/100);
                if (theProb)
        ...
        /*this.getProblemDetailURL = function(probNum, callback){
            fetchProbs(function(e, probs){
                var theProb = parseInt(probNum);
                if (theProb)
                {
                    callback(null, 'http://uhunt.felix-halim.net/api/p/num/'+ theProb);
                    return;
                }
